...
const PostForm: React.FC<
  InjectedFormProps<PostFormValuesType, PostFormOwnPropsType> &
    PostFormOwnPropsType
> = (props) => {
  return (
    <Form onSubmit={props.handleSubmit}>
      <Field
        validate={[requiredField, maxLenght30]}
...
export default reduxForm<PostFormValuesType, PostFormOwnPropsType>({
  form: "posts",
})(PostForm);
