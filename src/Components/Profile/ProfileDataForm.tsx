...
const ProfileDataForm: React.FC<InjectedFormProps<profileType, PostFormOwnPropsType> & PostFormOwnPropsType> = ({ profile, setEditProfileDataMode, handleSubmit, error }) => {
    return (
...
export default reduxForm<profileType, PostFormOwnPropsType>({ form: 'updateProfile' })(ProfileDataForm);